      ...
      <nav className="fixed top-0 left-0 right-0 z-50" style={{ backgroundColor: 'rgba(255, 255, 255, 0.98)', backdropFilter: 'blur(20px)', borderBottom: '1px solid rgba(229, 229, 229, 0.3)' }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center space-x-4">
              <a href="/signup" className="text-sm font-semibold px-6 py-3 rounded-xl border hover:shadow-lg transition-all duration-300" style={{ color: '#003D7A', borderColor: '#E5E5E5', backgroundColor: 'white' }}>Sign Up</a>
              ...
              <div className="relative group">
                ...
                >
                  ...
                  <div className="flex justify-between items-center text-sm">
                    <label className="flex items-center cursor-pointer group" style={{ color: '#2C2C2C' }}>
                      <input 
                        type="checkbox" 
                      ...
                      />
                      <span className="transition-colors duration-200" style={{ color: '#2C2C2C' }} onMouseEnter={e => e.target.style.color = '#003D7A'} onMouseLeave={e => e.target.style.color = '#2C2C2C'}>Remember me</span>
                    </label>
                    <button 
                      type="button" 

...
export default function TopBar({ exportPdf, onBack, showReveal, setShowReveal }) {
  return (
    <div className="absolute top-0 left-0 w-full flex justify-between items-center px-16 py-8 z-20">
      ...
      <div className="flex gap-2">
        <button className="bg-purple-600 hover:bg-purple-700 text-white font-semibold px-6 py-2 rounded shadow" onClick={exportPdf}>Export PDF</button>

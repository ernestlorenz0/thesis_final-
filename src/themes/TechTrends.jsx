...
export function TitleSlide({ title, subtitle }) {
  return (
    <div className="bg-gradient-to-br from-gray-700 to-blue-900 text-white p-12 rounded-2xl shadow-lg flex flex-col items-center justify-center h-full animate-fade-in border-4 border-blue-800">
...
export function ContentSlide({ title, content }) {
  return (
    <div className="bg-gray-800 text-white p-10 rounded-xl shadow flex flex-col gap-4 animate-slide-up border-2 border-blue-800">
...
export function ImageSlide({ title, imageUrl }) {
  return (
    <div className="bg-blue-900 text-white p-10 rounded-xl shadow flex flex-col items-center animate-fade-in border-2 border-blue-800">

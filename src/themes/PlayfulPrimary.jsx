...
export function MainSlide1({ title, content, imageUrl, autoGeneratedImage }) {
  return (
    <section className="relative w-[1920px] h-[1080px] bg-playful-100 flex items-center justify-between text-playful-900 animate-fade-in px-16 overflow-hidden">
      {/* Playful background shapes */}
      <div className="absolute w-32 h-32 bg-pink-300 rounded-full opacity-20 top-8 left-8 animate-bounce"></div>
      <div className="absolute w-48 h-48 bg-blue-300 rotate-45 opacity-20 bottom-8 right-12 animate-pulse"></div>
      <div className="absolute w-24 h-24 bg-yellow-300 rounded-full opacity-20 top-1/3 right-1/4 animate-bounce"></div>
      <div className="absolute w-36 h-36 bg-green-300 rounded-2xl opacity-20 bottom-1/4 left-1/3 rotate-12 animate-pulse"></div>
      ...
      <div className="relative z-10 w-1/2 h-full flex items-center justify-center pr-8">
        {autoGeneratedImage ? (
          <img 
            ...
            alt={title} 
            className="max-w-full max-h-full object-contain rounded-2xl shadow-2xl border-8 border-white animate-bounce-in" 
          />
        ) : (
          <div className="w-4/5 h-4/5 bg-white/90 border-8 border-playful-600 rounded-2xl flex flex-col items-center justify-center shadow-2xl animate-pulse">
            <div className="text-playful-700 text-4xl font-bold mb-4 animate-bounce">🎨 Auto Image Placeholder</div>
      ...
      <div className="relative z-10 w-1/2 px-8">
        {title && (
          <h2 className="text-6xl font-bold font-sans mb-6 drop-shadow-md bg-white/80 px-6 py-3 rounded-2xl text-center animate-bounce-in border-4 border-playful-500">
            {title}
          </h2>
        )}
        <div className="h-2 w-40 bg-playful-700 rounded-full mb-6 mx-auto animate-pulse"></div>
        {content && (
          <div className="bg-white/90 rounded-2xl p-6 shadow-xl border-4 border-playful-400 animate-fade-in">
            <p className="text-4xl font-sans leading-relaxed text-playful-800 text-center">{content}</p>
          </div>
        )}
      </div>
    </section>
    ...
    <section className="relative w-[1920px] h-[1080px] bg-gradient-to-br from-playful-200 via-playful-300 to-playful-400 overflow-hidden flex items-center justify-between px-16">
      ...
      <div className="relative z-10 w-1/2 h-full flex items-center justify-center pr-8">
        {autoGeneratedImage ? (
          ...
          <div className="w-4/5 h-4/5 bg-white/80 border-8 border-playful-500 rounded-2xl flex flex-col items-center justify-center shadow-2xl animate-pulse">
            <div className="text-playful-700 text-4xl font-bold mb-4 animate-bounce">🎨 Auto Image Placeholder</div>
      ...
      <div className="relative z-10 w-1/2 text-playful-900 px-8">
        {title && (
          <h2 className="text-6xl font-bold font-sans mb-6 drop-shadow-md bg-white/70 px-6 py-3 rounded-2xl text-center animate-bounce-in">
            {title}
          </h2>
        )}
        {content && (
          <div className="bg-white/80 rounded-2xl p-6 shadow-xl border-4 border-playful-400 animate-fade-in">

...
export function TitleSlide({ title, subtitle }) {
  return (
    <section className="w-[1280px] h-[720px] bg-gradient-to-br from-gray-100 to-gray-200 flex items-center px-24">
...
export function ImageSlide({ title, imageUrl, caption }) {
  return (
    <section className="w-[1280px] h-[720px] bg-gray-100 text-gray-900 px-20 py-12 flex items-center">
...
export function EndSlide({ message }) {
  return (
    <section className="relative w-[1280px] h-[720px] bg-gradient-to-br from-gray-200 to-gray-100 flex flex-col items-center justify-center text-gray-900 overflow-hidden">
